...
char *pdf_to_utf8_from_string(fz_context *ctx, char *src);

unsigned short *pdf_to_ucs2(fz_context *ctx, pdf_obj *src); /* sumatrapdf */
unsigned short *pdf_to_ucs2_from_string(fz_context *ctx, char *src);
int pdf_unicode_to_utf8(unsigned long unic, unsigned char *pcoutput);
