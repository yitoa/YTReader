...
fz_list_fill_path(fz_device *dev, fz_path *path, int even_odd, fz_matrix ctm,
	fz_colorspace *colorspace, float *color, float alpha)
{
	//PDFLOGI("[dev_list.c] fz_list_fill_path, start \n");
...
fz_list_fill_text(fz_device *dev, fz_text *text, fz_matrix ctm,
	fz_colorspace *colorspace, float *color, float alpha)
{
	//PDFLOGI("[dev_list.c] fz_list_fill_text, start \n");
...
{
	//PDFLOGI("[dev_list.c] fz_list_end_tile, start \n");
...
fz_run_display_list(fz_display_list *list, fz_device *dev, fz_matrix top_ctm, fz_bbox scissor, fz_cookie *cookie)
{
	...
	//PDFLOGI("[dev_list.c] fz_run_display_list, start \n");
	...
	for (node = list->first; node; node = node->next)
	{
		...
		//PDFLOGI("[dev_list.c] fz_run_display_list, node->cmd = %d \n", node->cmd);
		...
		//PDFLOGI("[dev_list.c] fz_run_display_list, clipped = %d, empty = %d \n", clipped, empty);
...
visible:
		...
		case FZ_CMD_FILL_TEXT:
		{
			//PDFLOGI("[dev_list.c] fz_run_display_list, FZ_CMD_FILL_TEXT \n");
