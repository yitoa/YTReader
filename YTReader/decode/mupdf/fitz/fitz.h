...
#if PDFDecodelog
#define PDFLOGI(...) __android_log_print(ANDROID_LOG_INFO,LOG_TAG,__VA_ARGS__)
#define PDFLOGE(...) __android_log_print(ANDROID_LOG_ERROR,LOG_TAG,__VA_ARGS__)
#else
#define PDFLOGI(...) do {} while(0)
#define PDFLOGE(...) do {} while(0)
#endif
...
enum
{
	...
	*/
	FZ_META_HAS_PERMISSION = 9,

	FZ_PERMISSION_PRINT = 90,
	FZ_PERMISSION_CHANGE = 91,
	FZ_PERMISSION_COPY = 92,
	FZ_PERMISSION_NOTES = 93,
