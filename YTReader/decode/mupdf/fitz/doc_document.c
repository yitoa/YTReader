...
{
	//PDFLOGI("[doc_document.c] fz_open_document start \n");
	PDFLOGI("[doc_document.c] fz_open_document, start, filename is %s \n", filename);
...
{
	PDFLOGI("[doc_document.c] fz_close_document start \n");
