...
public final class AndroidFontUtil {
	 ...
	 * @return Typeface
	 */
	public static Typeface getYTTypeface() {
		...
		if (null == typeface || !currentFont.equals(font)) {//字体没有初始化，或者字体改变
	...
	public static int getFontSize() {
		SharedPreferences style = context.getSharedPreferences(
				Constant.STYLE_REFERENCE, 0);
		int fontSize = style.getInt(DBSchema.COLUMN_STYLE_SIZE,
	 ...
	 * @return int
	 */
	public static int getLineSpacePixels() {
		SharedPreferences style = context.getSharedPreferences(
				Constant.STYLE_REFERENCE, 0);
		int lineSpacing = style.getInt(DBSchema.COLUMN_STYLE_LINE_SPACING,
	 ...
	 * @return int
	 */
	public static int getLineSpacePercent() {
		SharedPreferences style = context.getSharedPreferences(
				Constant.STYLE_REFERENCE, 0);
		int lineSpacing = style.getInt(DBSchema.COLUMN_STYLE_LINE_SPACING,
				Constant.STYLE_DEFAULT_LINE_SPACING);
		int lineSpacingPercent = 110;
		switch (lineSpacing) {
