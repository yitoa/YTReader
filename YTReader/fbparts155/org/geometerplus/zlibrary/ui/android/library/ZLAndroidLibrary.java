...
public final class ZLAndroidLibrary extends ZLibrary {
	...
	public BookView getWidget() {
		return myWidget;
	}
	
	public void setWidget(BookView widget) {
		myWidget = widget;
	}
	...
	public int getDisplayDPI() {
		if (myMetrics == null) {
			...
			myMetrics = appContext.getResources().getDisplayMetrics();
		}
		return myMetrics.densityDpi;
	}
