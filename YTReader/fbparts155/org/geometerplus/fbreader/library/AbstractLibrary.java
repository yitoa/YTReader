...
public abstract class AbstractLibrary {
	...
	public abstract boolean canRemoveBookFile(FBBook book);
	public abstract void removeBook(FBBook book, int removeMode);

	public abstract FBBook getRecentBook();
	public abstract FBBook getPreviousBook();
	public abstract void addBookToRecentList(FBBook book);

	public abstract boolean isBookInFavorites(FBBook book);
	public abstract void addBookToFavorites(FBBook book);
	public abstract void removeBookFromFavorites(FBBook book);

	public abstract void startBookSearch(final String pattern);

	public abstract List<Bookmark> allBookmarks();
	public abstract List<Bookmark> invisibleBookmarks(FBBook book);
}
