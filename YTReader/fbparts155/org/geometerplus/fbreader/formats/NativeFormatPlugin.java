...
public class NativeFormatPlugin extends FormatPlugin {
	...
	@Override
	synchronized public void readMetaInfo(FBBook book) throws BookReadingException {
		if (!readMetaInfoNative(book)) {
			throw new BookReadingException("errorReadingFile", book.File);
		}
	}

	private native boolean readMetaInfoNative(FBBook book);

	@Override
	public native void detectLanguageAndEncoding(FBBook book);
