...
class FB2CoverImage extends ZLImageProxy {
	...
	private static class BackgroundReader extends ZLXMLReaderAdapter {
		...
		private Base64EncodedCover myImage;

		Base64EncodedCover readCover(ZLFile file) {
			...
			case FB2Tag.BINARY:
				if (myImageReference != null) {
					...
					if (id != null && contentType != null && myImageReference.equals(id)) {
						...
						myImage = new Base64EncodedCover(contentType != null ? MimeType.get(contentType) : MimeType.IMAGE_AUTO, "-cover");
					}
				}
				break;
			}
