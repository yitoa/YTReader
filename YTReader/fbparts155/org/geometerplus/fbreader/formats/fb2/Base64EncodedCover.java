...
final class Base64EncodedCover extends ZLBase64EncodedImage {
	private final String myDirName;
	private OutputStreamWriter myStreamWriter;
	
	public Base64EncodedCover(MimeType mimeType, String namePostfix) {
	...
	protected String encodedFileName() {
		return myDirName + "/cover";
	}

	@Override
	protected String decodedFileName() {
		return myDirName + "/dcover";
	}
