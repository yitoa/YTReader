...
//    public static final String PROP_DISPLAY_TURBO_UPDATE_MODE ="crengine.display.turbo.update";
    ...
    public enum Lang {
    	DEFAULT("system", 0, R.raw.help_template_en),
    	EN("en", 1, R.raw.help_template_en),
    	DE("de", 2, 0),
    	ES("es", 3, 0),
    	FR("fr", 4, 0),
    	RU("ru", 5, R.raw.help_template_ru),
    	UK("uk", 6, R.raw.help_template_ru),
    	BG("bg", 7, 0),
    	SK("sk", 8, 0),
    	TR("tr", 9, 0),
    	LT("lt", 10, 0),
    	IT("it", 11, 0),
    	NL("nl", 12, 0),
    	ZH_CN("zh_CN", 13, R.raw.help_template_zh_cn),
    	;
