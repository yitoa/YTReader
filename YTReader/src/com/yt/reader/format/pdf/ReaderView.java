...
public class ReaderView extends AdapterView<Adapter> implements GestureDetector.OnGestureListener,
    ...
    public ReaderView(Context context, TextView tv, int totalPage) {
        super(context);
    ...
    public void moveToNext() {
        ...
        if (v != null)
            pageView.setText(mCurrent + 1 + "/" + totalPage);
    ...
    private Rect getScrollBounds(int left, int top, int right, int bottom) {
        ...
        int ymax = -top;
//        Log.v("scroll2", xmin + "-" + getWidth() + "-" + ymin + "-" + getHeight());
...
//        Log.v("scroll3", xmin + "-" + ymin + "-" + xmax + "-" + ymax);
