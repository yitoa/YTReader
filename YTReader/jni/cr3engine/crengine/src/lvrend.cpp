            ...
            case erm_table_cell:
                {
                    ...
                    context.updateRenderProgress(1);//段落数加1
...
//                }
                ...
                int count = txform->GetLineCount();//本段格式化行数
                for (int i=0; i<count; i++)
                {
